...
from lib.mirror.ingester import parse_permissions_json, IngesterError  # noqa: F401 (re-exported for tests)
from lib.mirror.tool_class import classify
...
def _sync(conn: sqlite3.Connection, project_id: int | None) -> None:
    ...
    """
    from lib.mirror import writer  # late import: avoids circular at module load
